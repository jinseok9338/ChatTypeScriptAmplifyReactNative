...
export default function MainTabNavigator() {
  ...
  return (
    <MainTopTab.Navigator
      ...
      />
      <MainTopTab.Screen name='Chats' component={TabTwoNavigator} />
      <MainTopTab.Screen name='Status' component={TabTwoNavigator} />
      <MainTopTab.Screen name='Calls' component={TabTwoNavigator} />
    </MainTopTab.Navigator>
  );
}
